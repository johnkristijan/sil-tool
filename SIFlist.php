          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="#">Cellar Deck</a>
                <a class="dropdown-item" href="#">Main Deck</a>
            ...
            <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <a class="dropdown-item" href="SIF.html">4.28.1</a>
                    </div>
                  </li>
          </ul>
...
<!-- Breadcumb -->
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">SIF list</li>
    </ol>
    </nav>
...
<div class="container-fluid" style="position:absolute;bottom:0px;right:0px;">
    <div class="alert alert-success" role="alert">
        <b>Status: </b>Status: SIF added successfully!
    </div>
</div>
